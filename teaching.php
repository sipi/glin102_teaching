...
<div id="teaching">
  ...
  HTML est initialement dérivé du Standard Generalized Markup Language (SGML).</cite> <span class="cite_source" >[Wikipedia 2012]</span> </p>
  ...
  <h4>Les outils</h4>
    <ul>
      ...
      <span onClick="toggle_aid('aid_traitement_texte')" class="view_aid" href="">Attention, un éditeur de texte n'est pas un traitement de texte</span>
